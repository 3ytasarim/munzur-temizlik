    ...
    <>
      ...
      <main>
        ...
        <section className="container-site pt-3 md:pt-6">
          <div
            className="relative flex h-[420px] items-end overflow-hidden rounded-[28px] bg-cover bg-[position:right_top] bg-no-repeat px-3 pb-3 pt-[185px] sm:h-[460px] sm:pt-[260px] md:min-h-[740px] md:items-center md:rounded-[37px] md:bg-center md:px-[7%] md:py-[7%]"
