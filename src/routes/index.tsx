    ...
    <>
      ...
      <main>
        ...
        <section className="container-site pt-3 md:pt-6">
          <div
            className="relative flex items-end overflow-hidden rounded-[28px] bg-[length:100%_auto] bg-[position:center_top] bg-no-repeat px-3 pb-3 pt-[250px] sm:pt-[320px] md:min-h-[740px] md:items-center md:rounded-[37px] md:bg-cover md:bg-center md:px-[7%] md:py-[7%]"
