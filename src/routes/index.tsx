    ...
    <>
      ...
      <main>
        ...
        <section className="container-site pt-3 md:pt-6">
          <div
            className="relative flex items-end overflow-hidden rounded-[28px] bg-[length:120%_auto] bg-[position:right_35%] bg-no-repeat px-3 pb-3 pt-[300px] sm:bg-[length:115%_auto] sm:bg-[position:right_30%] sm:pt-[340px] md:min-h-[740px] md:items-center md:rounded-[37px] md:bg-cover md:bg-center md:px-[7%] md:py-[7%]"
