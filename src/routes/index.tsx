    ...
    <>
      ...
      <main>
        ...
        <section className="container-site pt-3 md:pt-6">
          <div
            className="relative flex items-end overflow-hidden rounded-[28px] px-3 pb-3 pt-[280px] sm:pt-[320px] md:min-h-[740px] md:items-center md:rounded-[37px] md:px-[7%] md:py-[7%]"
          >
            <img
              src={images.heroImg}
              alt=""
              aria-hidden="true"
              className="absolute inset-0 h-full w-full scale-105 object-cover object-right-top sm:scale-110 md:scale-100 md:object-center"
            />
